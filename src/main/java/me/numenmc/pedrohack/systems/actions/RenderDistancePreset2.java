...
public class RenderDistancePreset2 extends ActionModule {
    ...
    public RenderDistancePreset2() {
        super("render-distance-p2", "Quickly change your render distance to a certain value. Useful for render distance glitch to load chunks on DonutSMP. (Preset 2)");
